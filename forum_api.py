...
async def get_questions(
    ...
    try:
        ...
        query = supabase.table('forum_questions').select('''
            *,
            profiles!forum_questions_student_id_fkey (
                full_name
            ),
            courses (
                title
        ...
        for question in response.data:
            ...
            questions.append(ForumQuestion(
                ...
                course_name=question['courses']['title'] if question.get('courses') else None,
                student_id=question['student_id'],
                student_name=question['profiles']['full_name'] if question.get('profiles') else 'Unknown Student',
...
async def get_question_with_answers(question_id: str):
    ...
    try:
        ...
        answers_response = supabase.table('forum_answers').select('''
            *,
            profiles!forum_answers_teacher_id_fkey (
                full_name
            )
        ...
        question = ForumQuestion(
            ...
            course_name=question_data['courses']['title'] if question_data.get('courses') else None,
            student_id=question_data['student_id'],
            student_name=question_data['profiles']['full_name'] if question_data.get('profiles') else 'Unknown Student',
        ...
        for answer_data in answers_response.data:
            answers.append(ForumAnswer(
                ...
                teacher_name=answer_data['profiles']['full_name'] if answer_data.get('profiles') else 'Unknown Teacher',
